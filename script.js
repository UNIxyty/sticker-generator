document.addEventListener("DOMContentLoaded", () => {
    ...
    downloadBtn.addEventListener("click", async () => {
      ...
      // Draw one text block: main text, line, subtext
      function drawBlock(mainText, subText, y) {
        ...
        // Draw line 4 pts below main text baseline
        const lineY = y - 4;
        drawLine(lineY);
  
        // Draw subtext 8 pts below line
        ...
        // Return next Y start position: subtextY minus 10 pts gap
        let nextY = subTextY - 13.5;
        if (nextY < 10) nextY = 10; // minimal bottom margin
        return nextY;
      }
  
      // Start Y just below image with 8 pts gap
